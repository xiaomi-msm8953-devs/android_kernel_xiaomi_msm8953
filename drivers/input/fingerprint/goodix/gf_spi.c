...
#define GF_NAV_UP_KEY  195 /* KEY_GESTURE_NAV_UP */
#define GF_NAV_DOWN_KEY  196 /* KEY_GESTURE_NAV_DOWN */
#define GF_NAV_LEFT_KEY  197 /* KEY_GESTURE_NAV_LEFT */
#define GF_NAV_RIGHT_KEY  198 /* KEY_GESTURE_NAV_RIGHT */
